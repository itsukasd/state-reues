...
class TestDeleteSubjectList():
  ...
  def test_deleteSubjectList(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".list-group-item:nth-child(4) .delete_subject path").click()
