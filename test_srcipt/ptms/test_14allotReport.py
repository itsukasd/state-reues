...
class Test14allotReport():
  ...
  def test_14allotReport(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".nav-reports_date_wise > p").click()
    self.driver.find_element(By.CSS_SELECTOR, ".fa-filter").click()
