...
class Test2addProject():
  ...
  def test_2addProject(self):
    ...
    self.driver.execute_script("arguments[0].click();", element)
    self.driver.find_element(By.ID, "name").send_keys('project'+str(random.randint(100,10000000000)))
    self.driver.find_element(By.ID, "description").send_keys('project'+str(random.randint(100,10000000000)))
