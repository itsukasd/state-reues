...
class Test4searchProject():
  ...
  def test_4searchProject(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#DataTables_Table_0_filter .form-control").send_keys("project1")
