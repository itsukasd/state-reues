...
class TestAddMenbers():
  ...
  def test_addMenbers(self):
    ...
    self.driver.find_element(By.ID, "nom").send_keys("test1")
    self.driver.find_element(By.ID, "prenom").send_keys("test1")
    self.driver.find_element(By.ID, "date_naissance").send_keys("1")
    self.driver.find_element(By.ID, "bouton_membre_fermer").click()
    ##$##
