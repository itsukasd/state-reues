...
class TestDeleteComponentList():
  ...
  def test_deleteComponentList(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".list-group-item:nth-child(3) .delete_component").click()
