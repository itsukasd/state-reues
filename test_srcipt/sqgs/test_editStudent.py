...
class TestEditStudent():
  ...
  def test_editStudent(self):
    ...
    self.driver.find_element(By.LINK_TEXT, "Edit").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".even:nth-child(4) #btnGroupDrop1")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    element = self.driver.find_element(By.CSS_SELECTOR, "body")
    actions = ActionChains(self.driver)
    ...
    self.driver.find_element(By.ID, "submit").click()
    self.driver.find_element(By.CSS_SELECTOR, "#uni_modal .btn-secondary").click()
    self.driver.find_element(By.CSS_SELECTOR, ".odd:nth-child(3) #btnGroupDrop1").click()
    self.driver.find_element(By.LINK_TEXT, "Edit").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".odd:nth-child(5) #btnGroupDrop1")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    element = self.driver.find_element(By.CSS_SELECTOR, "body")
    actions = ActionChains(self.driver)
