...
class TestAddAssessments6():
  ...
  def test_addAssessments6(self):
    ...
    self.driver.find_element(By.ID, "select2-component_id-container").click()
    self.driver.find_element(By.XPATH, '//*/span/ul/li[contains(text(),"Written")]').click()
    self.driver.find_element(By.ID, "name").click()
    self.driver.find_element(By.ID, "name").send_keys(random.sample('abcdefg123',10))
    self.driver.find_element(By.ID, "hps").click()
    self.driver.find_element(By.ID, "hps").send_keys("11")
