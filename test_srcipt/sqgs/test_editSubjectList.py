...
class TestEditSubjectList():
  ...
  def test_editSubjectList(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".list-group-item:nth-child(1) .edit_subject path").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".list-group-item:nth-child(2) .edit_subject > .svg-inline--fa").click()
    self.driver.find_element(By.ID, "submit").click()
    element = self.driver.find_element(By.ID, "submit")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
