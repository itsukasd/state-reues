...
class TestAddDepartment():
  ...
  def test_addDepartment(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#new_department > .svg-inline--fa").click()
    self.driver.find_element(By.ID, "name").click()
    self.driver.find_element(By.ID, "name").send_keys('Department'+str(random.randint(100,10000000000)))
