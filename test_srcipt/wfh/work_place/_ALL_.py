...
# This is node 1
driver.get("http://wfh/admin/login.php")
...
# This is node 5
driver.find_element(By.CSS_SELECTOR, "#new_position > .svg-inline--fa").click()
driver.find_element(By.ID, "name").click()
...
# This is node 42
driver.find_element(By.CSS_SELECTOR, ".list-group-item:nth-child(5) .delete_position path").click()
driver.find_element(By.ID, "confirm").click()
driver.find_element(By.ID, "dropdownMenuButton1").click()
safe_close(driver)
driver.switch_to.window(handles[2])
...
# This is node 47
driver.find_element(By.CSS_SELECTOR, ".list-group-item:nth-child(5) .edit_position path").click()
driver.find_element(By.ID, "submit").click()
driver.find_element(By.CSS_SELECTOR, "#uni_modal .btn-secondary").click()
driver.find_element(By.ID,"dropdownMenuButton1").click()
safe_close(driver)
safe_close(driver)
driver.switch_to.window(handles[50])
...
# This is node 3
driver.find_element(By.LINK_TEXT, "Employees").click()
driver.find_element(By.ID, "create_new").click()
driver.find_element(By.ID, "employee_code").click()
driver.find_element(By.ID, "employee_code").send_keys('Emcode'+str(random.randint(100,10000000000)))
...
driver.find_element(By.ID, "select2-position_id-container").click()
driver.find_element(By.XPATH, '//*[@id="select2-position_id-results"]/li[2]').click()
driver.find_element(By.ID, "submit").click()
...
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
...
# This is node 9
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#10
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 10
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#11
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 11
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#12
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 12
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#13
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 13
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#14
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 14
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#15
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 15
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#16
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 16
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#17
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 17
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#18
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 18
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#19
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 19
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#2
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 20
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#20
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 21
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#21
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 22
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#22
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 23
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#23
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 24
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#24
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 25
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#25
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 26
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#26
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 27
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#27
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 28
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#28
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 29
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#29
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 30
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#3
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 31
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#30
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 32
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#31
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 33
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#4
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 34
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#5
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 35
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#6
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 36
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#7
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 37
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#8
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 38
driver.find_element(By.CSS_SELECTOR, ".form-group > .btn").click()#9
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").click()
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("test")
driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys(Keys.ENTER)
driver.find_element(By.ID, "dropdownMenuButton1").click()
...
# This is node 49
driver.find_element(By.LINK_TEXT, "WFH - OAS").click()
