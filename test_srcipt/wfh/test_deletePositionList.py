...
class TestDeletePositionList():
  ...
  def test_deletePositionList(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".list-group-item:nth-child(5) .delete_position path").click()
